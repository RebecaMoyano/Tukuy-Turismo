                                            ...
                                            <div class="row g-0"> 
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-1.php" class="gallery-card">
                                                        <img src="../assets/img/waorani-images/img1.webp" alt="TUI Hotel Sardigame" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-2.php" class="gallery-card">
                                                        <img src="../assets/img/waorani-images/img2.jpg" alt="TUI Hotel Palm Garden" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-3.php" class="gallery-card">
                                                        <img src="../assets/img/waorani-images/img3.jpg" alt="TUI Hotel Palm Beach" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-4.php" class="gallery-card">
                                                        <img src="../assets/img/waorani-images/img4.webp" alt="TUI Hotel Sesa Oasis" class='img-fluid'>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="detalles-panel" role="tabpanel" aria-labelledby="detalles-tab-btn">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mt-4 mt-md-0">
                                        <div class="image-container">
                                            <img src="../assets/img/landscape.jpg" class="img-fluid rounded" alt="paisaje waorani">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class='container incluye'>
                            ...
                            <h2>QUÉ INCLUYE EL TOUR</h2>
                                <ul class='list-unstyled'> 
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Alojamiento en cabañas rústicas waorani: Estancia de 
                                    <?php echo $tourActual['duracion'] ?? '';?> en construcciones tradicionales adaptadas para vivistantes, ofreciendo comodidad 
                                y una experiencia auténtica.</li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Alimentación amazónica: Todas las comidad y bebidas, con énfasis en
                                ingredientes locales y platos típicos Waorani.</li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Actividades culturales y de aventura:
                                        <ul class='sublist list-unstyled'>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Caminatas guiadas por la selva: Descubre la fauna y flora local,
                                            aprendiendo sobre plantas medicinales y técnicas de supervivencia con guías waorani.</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Demostración de cerbatana: Aprende el arte de la caza tradicional
                                            con la cerbatana y dardos envenenados (solo demostración cultural, sin caza real).</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Visita a la cascada secreta: Disfruta de un refrescante baño en una
                                            cascada escondida dentro del territorio waorani.</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Compartir historias y cantos: Participa en reuniones nocturnas con 
                                            los miembros de la comunidad, escuchando sus mitos y leyendas.</li>
                                            <li>Observación de la fauna: Avistamiento de aves, monos y otros animales en su hábitat natural, guiado por expertos locales.</li>
                                        </ul>
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Transporte fluvial y terrestre: Vuelos charter a la zona de acceso más 
                                    cercana, seguidos de emocionantes traslados en canoa motorizada por el río y transporte terrestre 4x4.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Guías locales waorani: Acompañamiento constante de miembros de la comunidad
                                    waorani y un facilitador cultural, para una inmersión auténtica y respetuosa.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Fondo de conservación: Una parte de tu tour contribuye directamente a 
                                    los esfuerzos de protección del territorio waorani y el mantenimiento de su cultura ancestral.
                                    </li>
                                </ul>
                            </div>
                    </div>
