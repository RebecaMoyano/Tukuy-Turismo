                                            ...
                                            <div class="row g-0"> 
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-1.php" class="gallery-card">
                                                        <img src="../assets/img/shipibo-images/img1.jpg" alt="TUI Hotel Sardigame" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-2.php" class="gallery-card">
                                                        <img src="../assets/img/shipibo-images/img2.jpeg" alt="TUI Hotel Palm Garden" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-3.php" class="gallery-card">
                                                        <img src="../assets/img/shipibo-images/img3.jpeg " alt="TUI Hotel Palm Beach" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-4.php" class="gallery-card">
                                                        <img src="../assets/img/shipibo-images/img4.webp" alt="TUI Hotel Sesa Oasis" class='img-fluid'>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="detalles-panel" role="tabpanel" aria-labelledby="detalles-tab-btn">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mt-4 mt-md-0">
                                        <div class="image-container">
                                            <img src="../assets/img/landscape3.avif" class="img-fluid rounded" alt="paisaje shipibo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class='container incluye'>
                            ...
                            <h2>QUÉ INCLUYE EL TOUR</h2>
                                <ul class='list-unstyled'> 
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Alojamiento en comunidad: Estancia de 5 noches en cabañas 
                                    rústicas dentro de la comunidad Shipibo-Conibo, ofreciendo una auténtica inmersión cultural y un contacto directo con sus costumbres.</li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Alimentación local: Todas las comidas y bebidas basadas en productos
                                    frescos de la selva y recetas tradicionales Shipibo-Conibo, garantizando una experiencia culinaria genuina y saludable.</li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> 
                                        <ul class='sublist list-unstyled'> Actividades culturales y talleres:
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Taller de arte Kené: Aprende el significado y la elaboración 
                                                de los intrincados diseños geométricos Kené, patrimonio cultural Shipibo, y participa en la creación de una pieza.</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Ceremonia de bienvenida con cantos Ícaros: Experimenta 
                                                la espiritualidad Shipibo a través de sus cantos chamánicos tradicionales, una oportunidad única para conectar con su cosmovisión.</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Visita al jardín de plantas medicinales: Conoce el uso tradicional
                                                de la flora amazónica de la mano de un curandero local, descubriendo sus propiedades curativas y espirituales.</li>
                                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Demostración de pesca tradicional: Aprende técnicas 
                                                de pesca ancestrales junto a los miembros de la comunidad, observando su habilidad y respeto por el río.'</li>
                                        </ul>
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Excursiones en canoa: Navega por los ríos y cochas de la selva en canoas 
                                    tradicionales, con paradas para observación de vida silvestre (aves, monos, caimanes) y disfrute de los paisajes ribereños.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Guías locales bilingües: Serás acompañado por guías Shipibo-Conibo de la 
                                    propia comunidad y un traductor/facilitador, quienes compartirán sus conocimientos y tradiciones con profundo respeto.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Contribución a la comunidad: Una parte del costo de tu tour se destina directamente 
                                    a proyectos de desarrollo, educación y bienestar de la comunidad Shipibo-Conibo, apoyando su autosuficiencia y preservación cultural.
                                    </li>
                                </ul>
                            </div>
                    </div>
