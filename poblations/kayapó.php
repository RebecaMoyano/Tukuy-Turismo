...
if(file_exists('../tours_data.php')){
    ...
    exit('Error: no se encontró el archivo del tour.');
}
$tourId = 'kayapo'; 
...
$toursPorCara = 3; 
//todos los tours relacionados los divido en grupos de 3 para mostrarlos en el carrusel
...
<body>
                                            ...
                                            <div class="row g-0"> 
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-1.php" class="gallery-card">
                                                        <img src="../assets/img/kayapo-images/img1.jpg" alt="TUI Hotel Sardigame" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-2.php" class="gallery-card">
                                                        <img src="../assets/img/kayapo-images/img2.jpg" alt="TUI Hotel Palm Garden" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-3.php" class="gallery-card">
                                                        <img src="../assets/img/kayapo-images/img3.webp" alt="TUI Hotel Palm Beach" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-4.php" class="gallery-card">
                                                        <img src="../assets/img/kayapo-images/img4.webp" alt="TUI Hotel Sesa Oasis" class='img-fluid'>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="detalles-panel" role="tabpanel" aria-labelledby="detalles-tab-btn">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mt-4 mt-md-0">
                                        <div class="image-container">
                                            <img src="../assets/img/landscape.jpg" class="img-fluid rounded" alt="paisaje kayapó">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class='container incluye'>
                            ...
                            <h2>QUÉ INCLUYE EL TOUR</h2>
                                <ul class='list-unstyled'> 
                                    <li><i class="fa-solid fa-leaf"></i> Alojamiento tradicional: Estancia de 5 noches en una eco-choza tradicional construida con materiales locales, 
                                        ofreciendo comodidades rústicas pero confortables que te acercarán a la forma de vida de la población</li>
                                    <li><i class="fa-solid fa-leaf"></i> Gastronomía Auténtica: Todas las comidas y bebidas están incluidas, destacando la degustación
                                        de la "Moqueca Kayapó" y un delicioso guiso de pescado amazónico</li>
                                    <li><i class="fa-solid fa-leaf"></i> Actividades de inmersión:
                                        <ul class='sublist list-unstyled'>
                                            <li><i class="fa-solid fa-leaf"></i> Ritual del amanecer: Participa en una emotiva ceremonia
                                                matutina de agradecimiento a a selva, dirigida por un chamán</li>
                                            <li><i class="fa-solid fa-leaf"></i> Rastreo de fauna ancestral: Emabárcate en expediciones
                                                guiadas para el avistamiento de jaguares, tapires, y diversas aves endémicas, aprendiendo las técnicas de rastreo ancestrales
                                                y el conocimiento de la selva de los gúias kayapó</li>
                                            <li><i class="fa-solid fa-leaf"></i> Taller de pintura corporal: Aprende el significado de los diseñados
                                                kayapó y decora tu cuerpo con tintes naturales extraídos de plantas, una forma milenaria de expresión</li>
                                            <li><i class="fa-solid fa-leaf"></i> Visita a las comunas: Tendrás la oportunidad de visitar de cerca 
                                                las comunas, observando la vida cotidiana y las actividades de la comunidad, fomentando un intercambio cultural respetuoso</li>
                                        </ul>
                                    </li>
                                    <li><i class="fa-solid fa-leaf"></i> Transporte especializado: Todos los traslados están cubiertos, incluyendo emocionantes viajes fluviales 
                                        en canoas tradicionales, que te permiten navegar por los ríos de la Amazonía, y transporte terrestre en 
                                        vehículos 4x4 adaptados a los terrenos selváticos para tu comodidad y seguridad
                                    </li>
                                    <li><i class="fa-solid fa-leaf"></i> Guías expertos bilingÜes: Serás acompañado por los guías locales y expertos en la cultura kayapó y el sistema 
                                        amazónico, quienes compartirán sus conocimientos profundos y te ofrecerán una perspectiva auténtica
                                    </li>
                                    <li><i class="fa-solid fa-leaf"></i> Contribución comunitaria sostenible: En caso de que quieras apoyar nuestra labor, puedes colaborar con 
                                        nosotros y a las comunidades locales
                                    </li>
                                </ul>
                        </div>
                    </div>
    ...
    <div class='another-tours'>
        <h2 class='text-center'>Otros tours que podrían interesarte</h2>
            <div id="carouselRelatedTours" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                <div class="carousel-inner">
                    <?php if (!empty($toursAgrupados)):?>
                        <?php $first = true;?>
                    <!--aqui muestro el grupo de 3 tours relacionados que rellene anteriormente-->
                        <?php foreach ($toursAgrupados as $grupo): ?>
                            <div class="carousel-item <?php if ($first) echo 'active'; ?>">
                                <div class='row row-cols-1 row-cols-md-3 g-4 justify-content-center'>
                        <!--recorro cada grupo de los 3-->
