                ...
                <div class="tab-content w-100" id="tourInfoTabsContent">
                                            ...
                                            <div class="row g-0"> 
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-1.php" class="gallery-card">
                                                        <img src="../assets/img/munduruku-images/img1.jpeg" alt="TUI Hotel Sardigame" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-2.php" class="gallery-card">
                                                        <img src="../assets/img/munduruku-images/img2.jpg" alt="TUI Hotel Palm Garden" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-3.php" class="gallery-card">
                                                        <img src="../assets/img/munduruku-images/img3.jpg" alt="TUI Hotel Palm Beach" class='img-fluid'>
                                                    </a>
                                                </div>
                                                <div class="col-md-6 col-sm-6 gallery-item">
                                                    <a href="enlace-hotel-4.php" class="gallery-card">
                                                        <img src="../assets/img/munduruku-images/img4.jpeg" alt="TUI Hotel Sesa Oasis" class='img-fluid'>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="detalles-panel" role="tabpanel" aria-labelledby="detalles-tab-btn">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mt-4 mt-md-0">
                                        <div class="image-container">
                                            <img src="../assets/img/landscape.jpg" class="img-fluid rounded" alt="paisaje munduruku">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class='container incluye'>
                            ...
                            <ul class='list-unstyled'>
                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Alojamiento en malocas comunitarias: Estancia de 7 noches en auténticas malocas (casas comunales) Munduruku,
                                    con comodidades básicas para una inmersión profunda.
                                </li>
                                <li> <i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Dieta tradicional: Todas las comidad y bebidas preparadas con ingredientes frescos de la selva y siguiendo
                                    las recetas tradicionales de la comunidad.
                                </li>
                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Transporte fluvial: Traslados en embarcaciones locales desde la ciudad más cercana hasta la comunidad Munduruku.</li>
                                <ul class='list-unstyled sublist'><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Actividades de la inmersión cultural:
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Participación en el Ritual del Curare: Observa y aprende sobre la preparación y el uso del curare, un veneno 
                                        tradicional utilizado para la caza (demostración).
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Expediciones de caza y pesca con guías Munduruku: Acompaña a los cazadores y pescadores locales, aprendiendo 
                                        sus técnicas y el respeto por el ecosistema.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Taller de tallado de madera y cestería: Aprende las habilidades artesanales del pueblo Munduruku, creando tus 
                                        propias piezas.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Navgeación por el Río Tajapós: Exploración de afluentes y lagos en canoas tradicionales, con oportunidad 
                                        de observar la fauna y flora.
                                    </li>
                                    <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Historias alrededor del fuego: Noches de narración de mitos y leyendas Munduruku, acompañadas de cantos y danzas.</li>
                                </ul>
                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Guías especialistas: Acompañamiento constante de guías Munduruku y un facilitador bilingüe, expertos en la cultura y el entorno amazónico.</li>
                                <li><i class="fa-solid fa-leaf" style="color: #27aa78;"></i> Apoyo a la comunidad: Una parte de tu contribución se destina a proyectos de educación y sostenibilidad para el pueblo Munduruku.</li>
                            </ul>
                        </div>
                    </div>
